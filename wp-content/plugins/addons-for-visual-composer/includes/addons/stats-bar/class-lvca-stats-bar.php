...
class LVCA_Stats_Bars {
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        <div class="lvca-stats-bar">

            <div class="lvca-stats-title">
                <?php echo esc_html($stats_title) ?><span><?php echo esc_attr($percentage); ?>%</span>
            </div>

            <div class="lvca-stats-bar-wrap">

                <div <?php echo $color_style; ?> class="lvca-stats-bar-content"
                                                 data-perc="<?php echo esc_attr($percentage); ?>"></div>

                <div class="lvca-stats-bar-bg"></div>
