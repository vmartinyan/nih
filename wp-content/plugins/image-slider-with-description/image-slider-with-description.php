...
function ImgSlider_admin_options() 
{
	...
	echo '</form>';
	echo '<br /><p class="description">'.__( 'Note: Use the short code to add the gallery in to the posts and pages.', 'image-slider-with-description' ).'</p>';
	?>
	<p class="description">
...
function ImgSlider_shortcode( $atts ) 
{
	...
	if ( ! empty($data) ) 
	{
		...
		{ 
			 ...
			 $ImgSlider_desc = isset($data->ImgSlider_desc);
